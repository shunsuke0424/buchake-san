...
ActiveRecord::Schema[7.0].define(version: 2023_03_19_081545) do
  create_table "elects", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "elector_id"
    t.bigint "elected_id"
    t.bigint "question_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["elected_id"], name: "index_elects_on_elected_id"
    t.index ["elector_id", "elected_id", "question_id"], name: "index_elects_on_elector_id_and_elected_id_and_question_id", unique: true
    t.index ["elector_id"], name: "index_elects_on_elector_id"
    t.index ["question_id"], name: "index_elects_on_question_id"
  end
  ...
  add_foreign_key "elects", "questions"
  add_foreign_key "elects", "users", column: "elected_id"
  add_foreign_key "elects", "users", column: "elector_id"
